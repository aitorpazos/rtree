...
public final class Comparators {
    ...
    public static <T extends HasGeometry> Comparator<HasGeometry> overlapAreaComparator(
            final Zone r, final List<T> list) {
    ...
    public static Comparator<HasGeometry> areaComparator(final Zone r) {
        return new Comparator<HasGeometry>() {

            @Override
            public int compare(HasGeometry g1, HasGeometry g2) {
                return ((Float) g1.geometry().mbr().add(r).content()).compareTo(g2.geometry().mbr()
                        .add(r).content());
            }
        };
    }
